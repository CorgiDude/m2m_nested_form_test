...
# The ability to add existing Tags to an Item while creating or editing it with
auto-completion.
# The ability to create a new Tag while creating or editing an Item, if it does
not already exist.
...
* * Probably because the way the JS is writing the hidden fields, it believes the
tags are already part of the model.
